...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		closeHtml = '<span id="' + event._id + '" class="fc-delete" style="cursor:pointer"><i class="fa fa-fw fa-close"></i></span>';
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content">' +
					(this.isRTL ?
						closeHtml + ' ' + titleHtml + ' ' + timeHtml : // put a natural space in between
						closeHtml + ' ' + timeHtml + ' ' + titleHtml   //
						) +
				'</div>' +
...
TimeGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content">' + closeHtml +
					(timeText ?
						'<div class="fc-time"' +
