'use strict';
var elev_chat_controller = function($scope, $http, $state, $rootScope, $timeout, allUsers, loginUserToChat) {
                ...
                if (!$('#tabs-' + data[0].msgIDSender).length) {
                    if (tabCount() == 0) {
                        ...
                        createTab(data[0].msgIDSender, data[0].numeSender)
                            // message received. a tab is already active. create one and do not make it active
                    }
                }
