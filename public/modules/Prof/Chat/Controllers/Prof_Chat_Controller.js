'use strict';
var prof_chat_controller = function($scope, $http, $state, $rootScope, $timeout, promise, loginUserToChat) {
    ...
    $rootScope.disconnectSocket = function() {
        console.log("prof disconnect socket")
        mySocket.disconnect();
    }
